...
def fl_finetune(
        ...
        val_data_path: str = "../data/dataset2/8/local_training_0.json",
    ...
    r_p_list=[1,4,4,8,10,8,6,4]
    r_s_list=[7,36,12,32,22,40,10,8]
    ...
    for epoch in tqdm(range(num_communication_rounds)):
        ...
        for client_id in selected_clients_set:
            ...
            model0, local_dataset_len_dict, previously_selected_clients_set, last_client_id,local_global_dict_list[client_id] = client.terminate_local_training_svd(
                epoch, local_dataset_len_dict, previously_selected_clients_set, config, glocal=glocal)

            share_lora_state_dict[client_id],per_lora_state_dict[client_id] = per_share(rank[client_id], r_p_list[client_id], local_global_dict_list[client_id])
        ...
        global_dict_allw = FedAvg_all_rank2(selected_clients_set,
                       output_dir,
        ...
        for client_id in selected_clients_set:
            ...
            torch.save(new_adapter_weight, os.path.join(output_dir, str(epoch),f"local_output_{client_id}", "share_adapter_model.bin"))
